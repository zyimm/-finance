<?php
namespace Common\Service\Mailer;


use Psr\Log\LoggerInterface;
use Common\Service\Mailer\Exceptions\CodeException;
use Common\Service\Mailer\Exceptions\CryptoException;
use Common\Service\Mailer\Exceptions\SMTPException;
...
class SMTP
{
    ...
    public function send(Message $message)
    {
        ...
        $this->mailFrom()->rcptTo()->data()->quit();
